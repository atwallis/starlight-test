...
A quick guide to creating an endpoint with your own TypeScript implementation.

Use custom endpoints when you need logic beyond simple CRUD—like authentication, file uploads, or external API calls.
...
4. Enter your TypeScript interface:
...
2. Click **New**
3. Set **Type** to `CUSTOM_ONE` (or `CUSTOM_ARRAY` for lists)
...
> **Alternative:** Uncheck "Standard Request" to use a custom request type instead.
...
Click **Preview Schema**, review, and **Apply Changes**.
...
You created a custom endpoint with:

-   ✅ Custom response type
-   ✅ Request parameter validation
-   ✅ TypeScript handler implementation

For more details on types, error handling, and file uploads, see the [Endpoints Reference](../../reference/endpoints).
