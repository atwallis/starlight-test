...
3. **Restart the Express app** to test your changes:
   ```bash
   pnpm express:dev
   ```
...
To work on the schema editor UI (`apps/restura-ui/`):
...
<Aside type="caution">
Docker must be running for tests to work, as they require PostgreSQL.
</Aside>
