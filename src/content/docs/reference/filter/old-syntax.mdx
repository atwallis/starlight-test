...
<Aside type="caution">
This syntax is deprecated. Use the [new syntax](/starlight-test/reference/filter/new-syntax/) for new code.
</Aside>
...
<Aside type="tip">
Migrate to the [new syntax](/starlight-test/reference/filter/new-syntax/) for better readability and more features.
</Aside>
