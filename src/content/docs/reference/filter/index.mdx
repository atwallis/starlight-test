...
- **[New Syntax](/starlight-test/reference/filter/new-syntax/)** - Recommended compact syntax with operators, logical operations, and examples
- **[Old Syntax](/starlight-test/reference/filter/old-syntax/)** - Deprecated verbose syntax for backwards compatibility
- **[Advanced Topics](/starlight-test/reference/filter/advanced/)** - Value types, SQL injection prevention, and error handling
...
Get started with the [New Syntax](/starlight-test/reference/filter/new-syntax/) guide.
