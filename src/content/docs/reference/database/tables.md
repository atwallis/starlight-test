...
Learn more about [indexes and relationships](/starlight-test/reference/database/relationships/).
...
Learn more about [constraints](/starlight-test/reference/database/constraints/).
...
Learn more about [permissions](/starlight-test/reference/database/permissions/).

---

## Next Steps

-   [Configure columns and data types](/starlight-test/reference/database/columns/)
-   [Set up relationships with indexes and foreign keys](/starlight-test/reference/database/relationships/)
-   [Add validation with constraints](/starlight-test/reference/database/constraints/)
-   [Configure permissions](/starlight-test/reference/database/permissions/)
