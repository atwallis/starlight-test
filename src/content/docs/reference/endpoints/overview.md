...
Learn more about [SQL query building](/starlight-test/reference/endpoints/sql-queries/).
...
Learn more about [custom routes](/starlight-test/reference/endpoints/custom-routes/).
...
-   [Configure request parameters](/starlight-test/reference/endpoints/parameters/)
-   [Set up response configuration](/starlight-test/reference/endpoints/responses/)
-   [Build SQL queries](/starlight-test/reference/endpoints/sql-queries/)
-   [Create custom routes](/starlight-test/reference/endpoints/custom-routes/)
-   [Configure permissions](/starlight-test/reference/endpoints/permissions/)
