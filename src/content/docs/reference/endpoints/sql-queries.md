...
-   [Set up response properties](/starlight-test/reference/endpoints/responses/)
-   [Learn about database relationships](/starlight-test/reference/database/relationships/)
