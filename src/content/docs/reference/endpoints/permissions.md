...
Users must have both the `ADMIN` role AND the `write:users` scope.
...
-   [Set up SQL queries](/starlight-test/reference/endpoints/sql-queries/)
-   [Learn about database permissions](/starlight-test/reference/database/permissions/)
