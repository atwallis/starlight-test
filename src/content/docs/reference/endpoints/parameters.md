...
Learn more about [configuring global parameters](/starlight-test/reference/endpoints/permissions/#global-parameters).
...
Learn more about [pagination](/starlight-test/reference/endpoints/responses/#pagination).
...
Learn more about [error handling](/starlight-test/reference/endpoints/permissions/#error-handling).

---

## Next Steps

-   [Configure response properties](/starlight-test/reference/endpoints/responses/)
-   [Build SQL where clauses](/starlight-test/reference/endpoints/sql-queries/#where-clauses)
-   [Set up permissions](/starlight-test/reference/endpoints/permissions/)
